...
export default function LeadList() {
    ...
    const handleContactSync = async () => {
        ...
        try {
            ...
            const createdLeads = await Promise.all(newContacts.map(async (contact) => {
                const { data } = await createLead({
                    agent_id: user.id,
            ...
            const importedLeads = createdLeads.filter((lead) => Boolean(lead));
